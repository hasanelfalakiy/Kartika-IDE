...
object PreferenceKeys {
    ...
    const val EDITOR_PIN_LINE_NUMBER = "pin_line_number"
    ...
    const val KTFMT_MAX_WIDTH = "ktfmt_max_width"
    const val KTFMT_BLOCK_INDENT = "ktfmt_block_indent"
    const val KTFMT_CONTINUATION_INDENT = "ktfmt_continuation_indent"
    const val KTFMT_REMOVE_UNUSED_IMPORTS = "ktfmt_remove_unused_imports"
    const val KTFMT_MANAGE_TRAILING_COMMAS = "ktfmt_manage_trailing_commas"
